...
interface BeeswaxServiceIf {
   ...
   * 
   * @param \beeswax\Query $query
   * @return \beeswax\QueryHandle
   * @throws \beeswax\BeeswaxException
   */
  public function query(\beeswax\Query $query);
  /**
   ...
   * @throws \beeswax\BeeswaxException
   */
  public function executeAndWait(\beeswax\Query $query, $clientCtx);
  /**
   * Get the query plan for a query.
   * 
   * @param \beeswax\Query $query
   * @return \beeswax\QueryExplanation
   * @throws \beeswax\BeeswaxException
   */
  public function explain(\beeswax\Query $query);
  /**
   ...
   * 
   * @param \beeswax\QueryHandle $handle
   * @return \beeswax\ResultsMetadata Metadata information about the results.
   ...
   * @throws \beeswax\BeeswaxException
   */
  public function close(\beeswax\QueryHandle $handle);
  /**
...
class BeeswaxServiceClient implements \beeswax\BeeswaxServiceIf {
  ...
  public function send_query(\beeswax\Query $query)
  {
    $args = new \beeswax\BeeswaxService_query_args();
    $args->query = $query;
  ...
  public function recv_query()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_query_result();
  ...
  public function send_executeAndWait(\beeswax\Query $query, $clientCtx)
  {
    $args = new \beeswax\BeeswaxService_executeAndWait_args();
    $args->query = $query;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_executeAndWait_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_executeAndWait_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_explain(\beeswax\Query $query)
  {
    $args = new \beeswax\BeeswaxService_explain_args();
    $args->query = $query;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_explain_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_explain_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_fetch(\beeswax\QueryHandle $query_id, $start_over, $fetch_size)
  {
    $args = new \beeswax\BeeswaxService_fetch_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_fetch_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_fetch_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_state(\beeswax\QueryHandle $handle)
  {
    $args = new \beeswax\BeeswaxService_get_state_args();
    $args->handle = $handle;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_get_state_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_get_state_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_results_metadata(\beeswax\QueryHandle $handle)
  {
    $args = new \beeswax\BeeswaxService_get_results_metadata_args();
    $args->handle = $handle;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_get_results_metadata_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_get_results_metadata_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \beeswax\BeeswaxService_echo_args();
    $args->s = $s;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_echo_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_echo_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \beeswax\BeeswaxService_dump_config_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_dump_config_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_dump_config_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \beeswax\BeeswaxService_get_log_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_get_log_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_get_log_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \beeswax\BeeswaxService_get_default_configuration_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_get_default_configuration_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_get_default_configuration_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_close(\beeswax\QueryHandle $handle)
  {
    $args = new \beeswax\BeeswaxService_close_args();
    $args->handle = $handle;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_close_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_close_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->error !== null) {
  ...
  {
    $args = new \beeswax\BeeswaxService_clean_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\beeswax\BeeswaxService_clean_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \beeswax\BeeswaxService_clean_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    return;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \beeswax\QueryHandle();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\beeswax\QueryExplanation',
          ),
        1 => array(
          'var' => 'error',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \beeswax\QueryExplanation();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \beeswax\Results();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \beeswax\ResultsMetadata();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \beeswax\ConfigVariable();
